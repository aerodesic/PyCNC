...
res="$(${app} /usr/share/pycnc/tests/rects.gcode 2>&1)"
res="${res}$(${app} /usr/share/pycnc/tests/circles.gcode 2>&1)"
res="${res}$(${app} /usr/share/pycnc/tests/test_parser.gcode 2>&1)"
